...
public class ComfyUiWebSocketListener extends TextWebSocketHandler {
    ...
    public ComfyUiWebSocketListener(String host, String clientId, Consumer<String> onComplete, Consumer<String> onError) {
        this.host = host;
    ...
    protected void handleTextMessage(WebSocketSession session, TextMessage message) {
        try {
            ComfyUiWebSocketMessage msg = objectMapper.readValue(message.getPayload(), ComfyUiWebSocketMessage.class);
