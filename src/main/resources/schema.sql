...
CREATE TABLE IF NOT EXISTS interaction (id UUID NOT NULL PRIMARY KEY, role UUID NOT NULL, actor UUID NOT NULL, session UUID NOT NULL, timestamp BIGINT NOT NULL, text LONGTEXT NOT NULL, context UUID NOT NULL, parent UUID, mood TEXT, emoji TEXT);
